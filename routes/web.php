...
use App\Http\Controllers\ProductRatioController;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::resource('singleProducts',SingleProductController::class);
    ...
    Route::resource('finished',FinishedProductsController::class);
